...
export const parametersList = [
  { title: 'Temperature', percentage: 99 , icon:TemperatureIcon },
  { title: 'Soil Moisture', percentage: 99 , icon:SoilIcon},
  { title: 'Wind Speed', percentage: 99, icon:WindSpeedIcon},
  { title: 'Wind Direction', percentage: 99, icon:WindDirectionIcon},
  { title: 'Humidity', percentage: 99, icon:HumidityIcon},
]
